...
the same fresh session; full suite green throughout; `VR-1170` closes `BL-0053`); `IP-1171` is
`READY` (its sole blocker, `IP-1170` reaching `VERIFIED`, has cleared, but it has not yet been
implemented); `IP-1174` remains
