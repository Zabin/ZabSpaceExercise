...
| **Feature Planning** | `feature-decomposition` skill output — Release Plan, Epic Catalog, Feature Catalog (`FEAT-xxxx`), Dependency Graph, and Review, decomposed from the approved requirements baseline. Upstream of, and distinct from, `docs/features/`'s `FS-xxx` specs. | [`feature-planning/INDEX.md`](feature-planning/INDEX.md) |
