...
**Pattern 1 — Determinism-first.** Per CLAUDE.md's load-bearing invariant and [R506](R506-machine-reasoning.md)'s symbolic-vs-
...
**Pattern 2 — Legibility-by-default.** Per DOM-008 §3 and [R506](R506-machine-reasoning.md): any in-world AI's behavior (Red
...
**Pattern 3 — Advisor-not-decider, checked at the right grain.** Per DOM-008 §4, [R503](R503-ai-decision-support.md), and [R507](R507-autonomous-planning-systems.md)'s
...
**Pattern 4 — Fog-of-war parity.** Per [R501](R501-human-ai-teaming.md)'s shared-mental-model concern and DOM-008 §3's parallel
...
**Pattern 5 — Pedagogical justification, not just technical feasibility.** Per [R503](R503-ai-decision-support.md)'s "always-correct
advisor" concern and [R507](R507-autonomous-planning-systems.md)'s skill-removal concern: a feature's justification in this PME context must
