...
> **Referenced By:** DOM-002, MSTR-003, [R316](R316-joint-and-combined-operations.md), [R607](R607-assessment-of-learning-in-wargames.md)
...
Covers Boyd's Observe-Orient-Decide-Act loop as the formal name for the simulator's plan-execute
unit and its four-stage mapping onto engine mechanics. Does **not** cover the bounded-rationality
constraints each stage operates under ([R206](R206-bounded-rationality.md)), the concrete plan/task/
execute/assess loop this formalism names ([R106](R106-mission-operations.md)), or single-agent
decision criteria within the Decide stage ([R202](R202-decision-theory.md)).
...
([Boyd, J. R., *A Discourse on Winning and Losing*, ed. Hammond, G. T., Air University Press, 2018](https://www.coljohnboyd.com/static/documents/2018-03__Boyd_John_R__edited_Hammond_Grant_T__A_Discourse_on_Winning_and_Losing.pdf)
([Wayback](https://web.archive.org/web/2026/https://www.coljohnboyd.com/static/documents/2018-03__Boyd_John_R__edited_Hammond_Grant_T__A_Discourse_on_Winning_and_Losing.pdf))).
...
else equal — though see §5 below for the important caveat.
...
- *Boyd, J. R., A Discourse on Winning and Losing*, ed. Hammond, G. T. (Air University Press, 2018) — [live](https://www.coljohnboyd.com/static/documents/2018-03__Boyd_John_R__edited_Hammond_Grant_T__A_Discourse_on_Winning_and_Losing.pdf)
  · [snapshot](https://web.archive.org/web/2026/https://www.coljohnboyd.com/static/documents/2018-03__Boyd_John_R__edited_Hammond_Grant_T__A_Discourse_on_Winning_and_Losing.pdf)
  · accessed 2026-07-02.
