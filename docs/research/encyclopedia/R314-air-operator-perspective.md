...
> (Maritime Operator Perspective — the tier's other domain-analogy chapter, covering sea control/denial
> and naval C2 rather than air), [`research/01-doctrine-western.md`](../01-doctrine-western.md)
...
ground), [R313](R313-maritime-operator-perspective.md) (Maritime Operator Perspective — the tier's
sibling domain-analogy chapter; sea control/denial and naval C2 cover the slower, attrition-and-
sustainment-dominated half of the cross-domain analogy this chapter's faster, tasking-cycle-dominated
air-domain material complements), [`research/01-doctrine-western.md`](../01-doctrine-western.md) (the
