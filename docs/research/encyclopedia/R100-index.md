...
**Status:** R101, R102, R103, R105, R111 authored (✅) as the first batch — chosen because they map
directly to the simulator's highest-traffic subsystems (orbits, custody, C2, bus power) and were
flagged in the Jun 2026 audits as areas where implementers had previously misunderstood causality
(e.g. the SoC/eclipse confusion in `AUDIT-2026-06-UI-TTC.md` §2). Remaining 15 topics ⛔ Planned —
see `ROADMAP.md` for authoring sequence.
