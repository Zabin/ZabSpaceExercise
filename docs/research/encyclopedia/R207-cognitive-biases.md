...
> **Related Topics:** R205 (Cognitive Psychology Foundations), R201 (Probability — the normative
> baseline biases depart from), R105 (Custody Theory — where misjudgment of confidence is most
...
updating toward uncertainty, the opposite of the Bayesian ideal (R201).
...
assessment even as fresher, more diagnostic organic observations arrive (relevant to R119's
...
relevant directly to the weapons-quality threshold (R105 §3): an operator who treats a borderline
...
this bias; R205's discussion of change blindness is the flip side of the same attentional economy.
...
relevant to kinetic engagement decisions (R117) where an operator who has already expended ammo or
...
red-teaming per R308, explicit confidence-interval reporting per R201) exist as institutional
...
- **Don't design UI in a way that amplifies a known bias** — e.g., a persistent "first guess" field
  ...
  bias over-reaction; R205's salience guidance and this topic's bias catalog should be checked
...
R205 (the perceptual substrate biases act on), R201 (the normative Bayesian baseline biases depart
from), R105 (Custody Theory, the highest-stakes application), DOM-002 §9.
