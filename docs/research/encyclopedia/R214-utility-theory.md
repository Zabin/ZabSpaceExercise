...
> **Referenced By:** [R212](R212-multi-criteria-decision-analysis.md)
> **Produces:** the vocabulary for formalizing "value"/risk-attitude that [R202](R202-decision-theory.md)'s expected-value math and [R212](R212-multi-criteria-decision-analysis.md)'s MCDA scoring both depend on
...
[R202](R202-decision-theory.md)'s expected-value criterion silently assumes a "value" function exists to multiply probabilities
...
operational decision-makers facing an irreversible kinetic decision ([R117](R117-directed-energy-and-kinetic-effects.md)) are typically modeled as
...
[R212](R212-multi-criteria-decision-analysis.md)'s MCDA weighting requires) is exactly a multi-attribute utility theory problem — and the
formal warning is the same as [R212](R212-multi-criteria-decision-analysis.md)'s: an implicit, unstated trade-off rate between dimensions is
doing real normative work and should be made visible, not buried in a weighted-sum formula's
constants.

**Utility is not the same as the engine's declared severity tags.** `debris_risk="high"` ([R117](R117-directed-energy-and-kinetic-effects.md) §2)
