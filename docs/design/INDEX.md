...
> Numbering preserves the original series (08 was never used). The implemented operator console is
> specified in [`../build-spec/07-operator-console.md`](../build-spec/07-operator-console.md).
